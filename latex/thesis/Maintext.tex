...
\begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{figures/bipartite.png}
...
For each file $f$ that $a_1$ and $a_2$ authors touch, we sum up the minimum and maximum weights the authors have towards each file, then we divide the sum of minimums with the sum of maximums.
