...
\subsubsection{Release and issue measures}
\begin{itemize}
    \item Releases --> \cite{senApplicationSurvivalModel2015}
    \begin{itemize}
        \item Basic metrics: issues opened, issues closed, avg issue time, etc\dots
        \item Releases are gathered from tags --> cleaning (beta versions, etc\dots)
        \item 
    \end{itemize}
    \item Issues
    \begin{itemize}
        \item features vs bugs --> based on text
        \item survival analysis
        \item "survival probabilities for project issues after 1, 2, 3, 7, 30, 100,and 365 days. " \cite{jarczykSurgicalTeamsGitHub2018}
    \end{itemize}
\end{itemize}
