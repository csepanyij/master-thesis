...
\begin{table}[!htbp] \centering
    ...
    \\[-1.8ex]\hline
    \hline \\[-1.8ex]
    & \multicolumn{4}{c}{\textit{Dependent variable: Number of lines changed (log)}} \
    \cr \cline{4-5}
    \\[-1.8ex] & (1) & (2) & (3) & (4) \\
    \hline \\[-1.8ex]
