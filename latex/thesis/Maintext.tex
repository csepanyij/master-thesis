...
The summary of the remaining 78 projects is shown in Table \ref{tab:repo_stats}, the main programming languages and their distribution in Table \ref{tab:repo_lang}, and the full list of the 110 randomized repositories can be found in Appendix \ref{app:repos}.
...
\begin{table}
    ...
    \begin{tabular}{| l | c | c |}
        \hline
        \textbf{Main lang} & \textbf{Count} & \textbf{\%} \\
        \hline
        \textbf{C++} & 21 & 26,9\% \\
